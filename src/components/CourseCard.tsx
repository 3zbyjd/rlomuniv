            ...
            <Container maxWidth="container.xl">
                ...
                <Card maxW='xs'>
                    ...
                    <Stack mt='6' spacing='3'>
                        ...
                        <Text>
                        Learn to code in python by building a web scraper.                        
                        </Text>
                ...
                <Card maxW='xs'>
                    ...
                    <Stack mt='6' spacing='3'>
                        ...
                        <Text>
                        Learn to use nothing but bodyweight to get in shape. Learn receipies that will fuel fat burnig
                        </Text>
                        <Text color='blue.600' fontSize='2xl'>
                        $40
                        </Text>
                ...
                <Card maxW='xs'>
                    ...
                    <Stack mt='6' spacing='3'>
                        ...
                        <Text>
                        So, you&apos;ve excepted Christ. Now what?
                        </Text>
                        <Text color='blue.600' fontSize='2xl'>
                        $50
                        </Text>
                ...
                <Card maxW='xs'>
                    ...
                    />
                    <Stack mt='6' spacing='3'>
                        <Heading size='md'>Learn to use git for collaborative coding</Heading>
                        <Text>
                        Git is a popular code repo. Learn to use it for collaborative coding.
                        </Text>
                        <Text color='blue.600' fontSize='2xl'>
                        $30
                        </Text>
                ...
                <Card maxW='xs'>
                    ...
                    <Stack mt='6' spacing='3'>
                        ...
                        <Text>
                        Starting a business can be a very daunting task. This course will give you a step by step plan to start your own business.
                        </Text>
                        <Text color='blue.600' fontSize='2xl'>
                        $35
                        </Text>
